...
class CategoryListViewControllerTest: XCTestCase {
    ...
    func test_tableViewIsNotNilAfterViewDidLoad() {
        ...
        let sut = storyboard.instantiateViewController(withIdentifier: "CategoryListViewController") as!
    ...
    func testViewDidLoad_ShouldSetDelegateAndDataSourceToTheSameObject() {
        ...
        XCTAssertEqual(sut.categoryTableView.delegate as? CategoryListDataProvider, sut.categoryTableView.dataSource as?
